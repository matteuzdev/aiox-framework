...
> **Version:** 1.1.0 | **Ratified:** 2025-01-30 | **Last Amended:** 2026-04-03
...
### VI. Visible Handoffs (MUST)

Handoffs entre agentes ou squads não podem ficar implícitos. A operação precisa ser rastreável por humanos.

**Regras:**
- MUST: Toda troca real de ownership entre agentes ou squads DEVE gerar um handoff visível
- MUST: O handoff DEVE nomear `de`, `para`, `objetivo`, `artefatos`, `criterio_de_aceite` e `status`
- MUST: Handoffs DEVEM referenciar o artefato concreto entregue ao próximo agente
- MUST NOT: Simular handoff quando não houve transferência real de responsabilidade
- SHOULD: O handoff ser curto, escaneável e legível em terminal
...
de: <agent-or-squad>
para: <agent-or-squad>
objetivo: <next owned outcome>
artefatos: <files, links, outputs>
criterio_de_aceite: <what acceptance looks like>
status: ready | blocked
[/HANDOFF]
```

**Gate:** WARN se o fluxo multiagente ocorrer sem handoff explícito

---

### VII. Absolute Imports (SHOULD)
